...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/customer/Desktop/ZZ/anomaly/GLAD-main/hdd/Datasets/VisA_pytorch')
...
# nohup python dinomaly_visa_uni.py > dinomaly_visa_uni.log 2>&1 &