...
def train(item_list, model_paths):
    ...
    writer = SummaryWriter(
        log_dir='./checkpoint_paths/mpddad0.0001/logs')
    ...
    for epoch in range(0, 7):
        ...
        checkpoint_path = os.path.join('./checkpoint_paths/mpddad0.0001', f'epoch_{epoch}_costfilter_dinaomaly_my_mpddad.pth')
        torch.save({
            # 'epoch': epoch,
...
def test_only(item_list, model_paths):
    ...
    log_file_path = "./checkpoint_paths/mpddad0.0001/log_dinomaly_my_mpdd.txt"
    ...
    with open(log_file_path, "a") as log_file:
        ...
        for epoch_ in range(1): 
            ...
            model_path_unet = os.path.join('./checkpoint_paths/mpddad0.0001/costfilter_dinaomaly_mpdd.pth')
            import time
...
def compute_dynamic_gamma(cls_out, clsname, target, dino_resolution, num_classes=15):
    ...
    difficult_classes = ['bracket_black', 'bracket_brown', 'tubes']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/sysmanager/customer/Desktop/ZZ/anomaly/GLAD-main/hdd/Datasets/MPDD') # replace to the path of your MPDD dataset 
    parser.add_argument('--save_dir', type=str, default='./saved_results_mpdd')
    parser.add_argument('--save_name', type=str,
                        default='vitill_MPDD_uni_dinov2br_c392_en29_bn4dp2_de8_laelu_md2_i1_it10k_sams2e3_wd1e4_w1hcosa2e4_ghmp09f01w01_b16_s1')
    parser.add_argument('--train', action='store_true', help='train setting')
    args = parser.parse_args()
    #
    # item_list = ['metal_plate',]
    ...
    model_paths = [
        os.path.join(args.save_dir, args.save_name, "model_8000.pth"),
...
# nohup python costfilter_dinomaly_mpdd_uni_my_train_test.py --train > costfilter_dinomaly_mpdd_uni_my_train.log 2>&1 &


# nohup python costfilter_dinomaly_mpdd_uni_my_train_test.py > costfilter_dinomaly_mpdd_uni_my_test.log 2>&1 &
