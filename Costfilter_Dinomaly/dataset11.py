...
class MVTecDataset_train(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # image_orig = img.copy()
        # synth_mask = torch.zeros([1, img.size()[-2], img.size()[-2]])
        ...
        # synth_img = transforms.ToTensor()(synth_img)
        # synth_mask = transforms.ToTensor()(synth_mask)
    ...
    def generate_anomaly(self, image):
        ...
        anomaly_source_paths = sorted(glob.glob("/home/customer/Desktop/ZZ/anomaly/GLAD-main/hdd/Datasets/dtd/images" + "/*/*.jpg"))
