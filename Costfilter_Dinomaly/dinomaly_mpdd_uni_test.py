...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/customer/Desktop/ZZ/anomaly/GLAD-main/hdd/Datasets/MPDD')
...
# nohup python dinomaly_mpdd_uni_test.py > dinomaly_mpdd_uni_test.log 2>&1 &