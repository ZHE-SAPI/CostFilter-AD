...
def train(item_list, model_paths):
    ...
    writer = SummaryWriter(
        log_dir='./checkpoint_paths/btadad0.0001/logs')
    ...
    for epoch in range(0, 2):
        ...
        checkpoint_path = os.path.join('./checkpoint_paths/btadad0.0001', f'epoch_{epoch}_costfilter_dinaomaly_my_btadad.pth')
        torch.save({
...
def test_only(item_list, model_paths):
    ...
    log_file_path = "./checkpoint_paths/btadad0.0001/log_dinomaly_my_btad.txt"
    ...
    with open(log_file_path, "a") as log_file:
        ...
        # for epoch_ in range(28,max_epochs): 
        for epoch_ in range(1): 
            model_path_unet = os.path.join('./checkpoint_paths/btadad0.0001/costfilter_dinaomaly_btad.pth')
            import time
            ...
            for item, test_data in zip(item_list, test_data_list):
                test_dataloader = torch.utils.data.DataLoader(test_data, batch_size=batch_size, shuffle=False,
                                                              num_workers=4)
                results = evaluation_batch(model, model_unet, test_dataloader, device, max_ratio=0.01, resize_mask=256, lamda=0.1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/sysmanager/customer/Desktop/ZZ/anomaly/GLAD-main/hdd/Datasets/BTAD1') # replace to the path of your BTAD dataset 
...
# cd /home/sysmanager/customer/Desktop/ZZ/anomaly/CostFilterAD/Costfilter_Dinomaly                # change to your project path

# nohup python costfilter_dinomaly_btad_uni_my_train_test.py --train > costfilter_dinomaly_btad_uni_my_train.log 2>&1 &


# nohup python costfilter_dinomaly_btad_uni_my_train_test.py > costfilter_dinomaly_btad_uni_my_test.log 2>&1 &
