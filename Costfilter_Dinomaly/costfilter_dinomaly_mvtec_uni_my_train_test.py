...
def train(item_list, model_paths):
    ...
    writer = SummaryWriter(
        log_dir='./checkpoint_paths/mvtecad0.0001/logs')
    ...
    for epoch in range(0, 17):
        ...
        checkpoint_path = os.path.join('./checkpoint_paths/mvtecad0.0001', f'epoch_{epoch}_costfilter_dinaomaly_my_mvtecad.pth')
        torch.save({
            # 'epoch': epoch,
...
def test_only(item_list, model_paths):
    ...
    log_file_path = "./checkpoint_paths/mvtecad0.0001/log_dinomaly_my_mvtec.txt"
    ...
    with open(log_file_path, "a") as log_file:
        ...
        for epoch_ in range(1): 
            ...
            model_path_unet = os.path.join('./checkpoint_paths/mvtecad0.0001/costfilter_dinaomaly_mvtecad.pth')
            ...
            for item, test_data in zip(item_list, test_data_list):
                test_dataloader = torch.utils.data.DataLoader(test_data, batch_size=batch_size, shuffle=False,
                                                              num_workers=4)
                results = evaluation_batch(model, model_unet, test_dataloader, device, max_ratio=0.01, resize_mask=392, lamda=0.05)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/sysmanager/customer/Desktop/ZZ/anomaly/GLAD-main/hdd/Datasets/MVTec-AD') # replace to the path of your MVTec-AD dataset 
    ...
    model_paths = [
        os.path.join(args.save_dir, args.save_name, "model_10000.pth"),
...
# nohup python costfilter_dinomaly_mvtec_uni_my_train_test.py --train > costfilter_dinomaly_mvtec_uni_my_train.log 2>&1 &

# nohup python costfilter_dinomaly_mvtec_uni_my_train_test.py > costfilter_dinomaly_mvtec_uni_my_test.log 2>&1 &
