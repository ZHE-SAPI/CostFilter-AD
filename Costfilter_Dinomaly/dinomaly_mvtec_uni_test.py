...
import argparse
from utils11 import evaluation_batch, global_cosine, regional_cosine_hm_percent, global_cosine_hm_percent, \
    WarmCosineScheduler
...
def test_only(item_list, model_paths):
    ...
    for model_path in model_paths:
        ...
        input_size = (3, 392, 392)  # 输入通道、高度、宽度
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/customer/Desktop/ZZ/anomaly/GLAD-main/hdd/Datasets/MVTec-AD')
...
# nohup python dinomaly_mvtec_uni_test.py > dinomaly_mvtec_uni_test.log 2>&1 &