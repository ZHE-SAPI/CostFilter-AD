...
def test_2dunet_dino_DRAEM(model, dino_model, dino_frozen, val_pipe, weight_dtype, val_dataloader, args, device, class_name, checkpoint_step, log_file, model_num, iftest, len_dataset, a_, beta):
    ...
    # 读取数据       
    with open(f"/home/customer/Desktop/ZZ/anomaly/GLAD-main/MV-AO-VISA-AO/filtered_data-AO-{class_name}.pkl", "rb") as f:
        filtered_data = pickle.load(f)

    with open(f"/home/customer/Desktop/ZZ/anomaly/GLAD-main/MV-AO-VISA-AO/filtered_data-A-{class_name}.pkl", "rb") as f:
    ...
    # Save paths
    save_path_pixel = f"/home/customer/Desktop/ZZ/anomaly/GLAD-main/MV-AO-VISA-AO/roc_pixel_{class_name}.png"
    save_path_image = f"/home/customer/Desktop/ZZ/anomaly/GLAD-main/MV-AO-VISA-AO/roc_image_{class_name}.png"
    ...
    # 绘制 logits 分布
    save_path_pixel = f"/home/customer/Desktop/ZZ/anomaly/GLAD-main/MV-AO-VISA-AO/logits_pixel_{class_name}.png"
    save_path_image = f"/home/customer/Desktop/ZZ/anomaly/GLAD-main/MV-AO-VISA-AO/logits_image_{class_name}.png"
