...
class MVTecDataset(Dataset):
    ...
    def __init__(
            ...
            pt_root="/home/sysmanager/customer/Desktop/ZZ/anomaly/GLAD-main/train_anomaldino_save_path_1234_VISA/VisA_pytorch",
            # pt_root="./train_anomaldino_save_path_1234_VISA/VisA_pytorch"
                    ):
    ...
    def __getitem__(self, index):
        ...
        if self.type == 'train':
            ...
            pt_file_paths = self._get_random_pt_files(object_name, 5)  # 随机选 m 个 .pt 文件
            ...
            for pt_file_path in pt_file_paths:
                ...
                # 将特征添加到对应列表
                features_ref_3_list.append(data_dict["features_ref_3"]) # [0:1024]
                features_ref_6_list.append(data_dict["features_ref_6"]) # [0:1024]
                features_ref_9_list.append(data_dict["features_ref_9"]) # [0:1024]
                features_ref_12_list.append(data_dict["features_ref_12"]) # [0:1024]
            ...
            # 获取 object_name 并加载 .pt 文件
            object_name = self.get_object_name_from_path(example["instance_path"], self.masking_default)
            pt_file_paths = self._get_random_pt_files(object_name, 160)  # 随机选 m 个 .pt 文件
