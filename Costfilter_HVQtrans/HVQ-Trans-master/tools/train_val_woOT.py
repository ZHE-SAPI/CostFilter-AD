...
parser.add_argument("--config", default="./config_visa_woOT.yaml")  # config_visa.yaml
...
def main():
    ...
    if args.evaluate:
        ...
        # 定义保存输出的文件
        output_file = "/home/customer/Desktop/ZZ/anomaly/HVQ-Trans-master/model_comparison.txt"
    ...
    for epoch in range(last_epoch, config.trainer.max_epoch):
        ...
        if (epoch+2) % config.trainer.val_freq_epoch == 0:
