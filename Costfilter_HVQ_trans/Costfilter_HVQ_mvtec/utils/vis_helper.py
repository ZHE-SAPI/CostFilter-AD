...
def visualize_compound(fileinfos, preds, masks, pred_imgs, cfg_vis, cfg_reader):
    ...
    for i, fileinfo in enumerate(fileinfos):
        ...
        save_path_image = os.path.join(save_dir, f"{base_name}_image.JPG")
        save_path_pred_img = os.path.join(save_dir, f"{base_name}_pred_img.JPG")
        save_path_scoremap_global = os.path.join(save_dir, f"{base_name}_scoremap_global.JPG")
        save_path_scoremap_self = os.path.join(save_dir, f"{base_name}_scoremap_self.JPG")
        save_path_mask = os.path.join(save_dir, f"{base_name}_mask.JPG")
        save_path_pred_gray = os.path.join(save_dir, f"{base_name}_pred_gray.JPG")  # New save path for pred_gray
