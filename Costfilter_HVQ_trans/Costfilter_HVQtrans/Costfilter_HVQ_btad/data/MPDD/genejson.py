...
# # 数据集根目录
# dataset_root = "/home/ZZ/anomaly/GLAD-main/hdd/Datasets/MPDD"

# # 输出 JSON 文件路径
# train_json_path = "/home/ZZ/anomaly/HVQ-Trans-master/data/MPDD/train.json"
# test_json_path = "/home/ZZ/anomaly/HVQ-Trans-master/data/MPDD/test.json"
        ...
        if os.path.exists(test_path):
            for category in os.listdir(test_path):
                ...
                for filename in os.listdir(category_path):
                    ...
                    # 如果是异常类别，添加对应的掩码路径
                    if category != "good":
                        maskname = filename.replace(".JPG", ".png").replace(".jpg", ".png").replace(".png", "_mask.png")  # 根据规则生成掩码文件名
                        entry["maskname"] = f"{clsname}/ground_truth/{category}/{maskname}"
