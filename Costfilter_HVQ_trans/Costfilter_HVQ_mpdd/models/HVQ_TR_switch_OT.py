...
class HVQ_TR_switch_OT(nn.Module):
    ...
    def forward(self, inputs, device, out_pred_=False):
        ...
        # print('org_feature.size()', org_feature.size()) # 16,272,14,14
        ...
        return anomaly_map_all_bat, min_similarity_map_all_bat, dino_features, pred, inputs, (0.1 * nn.UpsamplingBilinear2d(scale_factor=64/14)(pred1).squeeze(1)/40)
